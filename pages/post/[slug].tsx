...
function Post({ post }: Props) {
    ...
    return (
        <main>
            <Header />
            <img className='w-full h-40 object-cover' src={urlFor(post.mainImage).url()!} alt={post.slug.current} />
            ...
            {submitted ? (
                ...
                <form onSubmit={handleSubmit(onSubmitHandler)} className='flex flex-col p-5 max-w-2xl mx-auto mb-10'>
                    ...
                    <div className='flex flex-col p-5'>
                        {errors.name && (<span className='text-red-500'>The Name Fields is required</span>)}
                        {errors.email && (<span className='text-red-500'>The Email Fields is required</span>)}
                        {errors.comment && (<span className='text-red-500'>The Comment Fields is required</span>)}
                    </div>
